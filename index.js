...
// ALTERAÇÃO: Agora responde no endereço raiz '/' em vez de '/api/messages'
app.get('/', async (req, res) => {
    try {
        console.log("A receber pedido para o endpoint raiz '/'");
        ...
        console.error("Erro final no endpoint raiz '/':", error.message);
